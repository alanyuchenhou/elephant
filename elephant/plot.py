...
def compare():
    ...
    models = ['pWSBM', 'bWSBM', 'SBM', 'DCWBM', 'node2vec', 'Model R', ]
    errors = pandas.DataFrame([
        [0.0486, 0.0543, 0.0632, 0.0746, 0.0171, 0.0131, ],
        [0.0407, 0.0462, 0.0497, 0.0500, 0.0614, 0.0303, ],
        [0.0571, 0.0594, 0.0634, 0.0653, 0.0386, 0.0369, ],
        [0.0726, 0.0845, 0.0851, 0.0882, 0.0312, 0.0376, ],
    ],
        data_sets,
        models,
    )
